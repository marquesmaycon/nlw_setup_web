...
const minimumSummary = 18 * 7
const amountOfDaysFill = minimumSummary - summaryDates.length
      ...
      <div className="w-full flex">
         ...
         <div className="grid grid-rows-7 grid-flow-col gap-3">
            ...
            {amountOfDaysFill > 0 && Array.from({ length: amountOfDaysFill }).map((_, i) => (
               <div key={i} className="w-10 h-10 bg-zinc-900 rounded-lg opacity-40 cursor-not-allowed">
